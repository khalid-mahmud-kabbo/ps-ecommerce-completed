            ...
            <div class="container text-center __pb-13px">
                ...
                <div
                    ...
                    <div class="col-md-3 footer-web-logo text-center text-md-start ">
                      ...
                      @if($appStoreDownload['status'] == 1 || $playStoreDownload['status'] == 1)
                       ...
                       @endif
                        ...
                        <div class="store-contents d-flex justify-content-center pr-lg-4">
                            @if($appStoreDownload['status'] == 1)
                                <div class="me-2 mb-2">
                                    <a class="" href="{{ $appStoreDownload['link'] }}" role="button">
                                        <img width="100"
                            ...
                            @if($playStoreDownload['status'] == 1)
                                <div class="me-2 mb-2">
                                    <a href="{{ $playStoreDownload['link'] }}" role="button">
                                        <img width="100"
